    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="kehuId" name="kehuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="评价内容" prop="feijipiaoCommentbackText">
                        <el-input type="textarea"  :readonly="ro.feijipiaoCommentbackText" v-model="ruleForm.feijipiaoCommentbackText" placeholder="评价内容"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.feijipiaoCommentbackText" label="评价内容" prop="feijipiaoCommentbackText">
                            <span v-html="ruleForm.feijipiaoCommentbackText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    feijipiaoId: false,
                    kehuId: false,
                    feijipiaoCommentbackText: false,
                    insertTime: false,
                    replyText: false,
                    updateTime: false,
                },
        ...
        created() {
            ...
            if (this.role != "管理员"){
                this.ro.feijipiaoId = true;//飞机票
                this.ro.kehuId = true;//客户
                this.ro.feijipiaoCommentbackText = true;//评价内容
            }
        ...
        methods: {
            ...
            info(id) {
                let _this =this;
                _this.$http({
                    url: `feijipiaoCommentback/info/${id}`,
                    method: 'get'
                }).then(({ data }) => {
                    if (data && data.code === 0) {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`feijipiaoCommentback/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.feijipiaoCommentbackCrossAddOrUpdateFlag = false;
                                        this.parent.search();
