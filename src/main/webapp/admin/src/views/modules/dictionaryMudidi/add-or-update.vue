<template>
    <div class="addEdit-block">
        ...
        >
            <el-row>
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="目的地编码" prop="codeIndex">
                        <el-input v-model="ruleForm.codeIndex"
                                  placeholder="目的地编码" clearable  :readonly="ro.codeIndex"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="目的地编码" prop="codeIndex">
                            <el-input v-model="ruleForm.codeIndex"
                                      placeholder="目的地编码" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="目的地" prop="indexName">
                        <el-input v-model="ruleForm.indexName"
                                  placeholder="目的地" clearable  :readonly="ro.indexName"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="目的地" prop="indexName">
                            <el-input v-model="ruleForm.indexName"
            ...
            onSubmit() {
                ...
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        ...
                        ruleForm["dicCode"]="mudidi_types";
                        ruleForm["dicName"]="目的地";
                        this.$http({
