    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="现积分" prop="kehuNewJifen">
                       <el-input v-model="ruleForm.kehuNewJifen"
                                 placeholder="现积分" clearable  :readonly="ro.kehuNewJifen"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="现积分" prop="kehuNewJifen">
                           <el-input v-model="ruleForm.kehuNewJifen"
