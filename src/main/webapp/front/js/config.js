...
var centerMenu = [
    ...
    ,{
        name: '飞机票收藏',
        url: '../feijipiaoCollection/list.html'
    }
    ,{
        name: '飞机票购买订单',
        url: '../feijipiaoOrder/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '飞机票',
        url: './pages/feijipiao/list.html'
    },
    {
        name: '航班管理动态',
        url: './pages/hangbanguanlidongtai/list.html'
    },
    {
        name: '使用帮助',
        url: './pages/shiyongbangzhu/list.html'
    },

]

var adminurl =  "http://localhost:8080/hangkongxinxiguanlixitong/admin/dist/index.html#/login";
