...
public class FeijipiaoOrderView extends FeijipiaoOrderEntity implements Serializable {
    private static final long serialVersionUID = 1L;
		...
		* 订单类型的值
		*/
		private String feijipiaoOrderValue;
		/**
		* 支付类型的值
		*/
		private String feijipiaoOrderPaymentValue;
	...
	public FeijipiaoOrderView(FeijipiaoOrderEntity feijipiaoOrderEntity) {
		try {
			...
			* 获取： 订单类型的值
			*/
			public String getFeijipiaoOrderValue() {
				return feijipiaoOrderValue;
			}
			/**
			* 设置： 订单类型的值
			*/
			public void setFeijipiaoOrderValue(String feijipiaoOrderValue) {
				this.feijipiaoOrderValue = feijipiaoOrderValue;
			}
			/**
			* 获取： 支付类型的值
			*/
			public String getFeijipiaoOrderPaymentValue() {
				return feijipiaoOrderPaymentValue;
			}
			/**
			* 设置： 支付类型的值
			*/
			public void setFeijipiaoOrderPaymentValue(String feijipiaoOrderPaymentValue) {
				this.feijipiaoOrderPaymentValue = feijipiaoOrderPaymentValue;
			}
