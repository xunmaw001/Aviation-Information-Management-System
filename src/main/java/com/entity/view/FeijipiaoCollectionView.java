...
public class FeijipiaoCollectionView extends FeijipiaoCollectionEntity implements Serializable {
    private static final long serialVersionUID = 1L;
		...
		* 类型的值
		*/
		private String feijipiaoCollectionValue;
	...
	public FeijipiaoCollectionView(FeijipiaoCollectionEntity feijipiaoCollectionEntity) {
		try {
			...
			* 获取： 类型的值
			*/
			public String getFeijipiaoCollectionValue() {
				return feijipiaoCollectionValue;
			}
			/**
			* 设置： 类型的值
			*/
			public void setFeijipiaoCollectionValue(String feijipiaoCollectionValue) {
				this.feijipiaoCollectionValue = feijipiaoCollectionValue;
			}
